...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x22, 0x33, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6c, 0x6f,
	...
	0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x34, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61,
...
var file_blog_blogpb_blog_proto_goTypes = []interface{}{
	...
	(*UpdateBlogRequest)(nil),  // 1: blog.UpdateBlogRequest
	(*UpdateBlogResponse)(nil), // 2: blog.UpdateBlogResponse
	(*CreateBlogRequest)(nil),  // 3: blog.CreateBlogRequest
	(*CreateBlogResponse)(nil), // 4: blog.CreateBlogResponse
	(*ReadBlogRequest)(nil),    // 5: blog.ReadBlogRequest
...
var file_blog_blogpb_blog_proto_depIdxs = []int32{
	...
	3, // 5: blog.BlogService.CreateBlog:input_type -> blog.CreateBlogRequest
	5, // 6: blog.BlogService.ReadBlog:input_type -> blog.ReadBlogRequest
	1, // 7: blog.BlogService.UpdateBlog:input_type -> blog.UpdateBlogRequest
	4, // 8: blog.BlogService.CreateBlog:output_type -> blog.CreateBlogResponse
	6, // 9: blog.BlogService.ReadBlog:output_type -> blog.ReadBlogResponse
	2, // 10: blog.BlogService.UpdateBlog:output_type -> blog.UpdateBlogResponse
