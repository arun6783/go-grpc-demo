...
type CreateBlogResponse struct {
	...
	Blog *Blog `protobuf:"bytes,1,opt,name=blog,proto3" json:"blog,omitempty"` //will have the blog_id generated
}
...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x22, 0x2c, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x6c, 0x6f,
	...
	0x22, 0x33, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65,
	...
	0x04, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x34, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42,
	...
	0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x33, 0x0a, 0x11, 0x43,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67,
	0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x32, 0x93, 0x02, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x67, 0x53,
...
var file_blog_blogpb_blog_proto_goTypes = []interface{}{
	...
	(*DeleteBlogRequest)(nil),  // 1: blog.DeleteBlogRequest
	(*DeleteBlogResponse)(nil), // 2: blog.DeleteBlogResponse
	(*UpdateBlogRequest)(nil),  // 3: blog.UpdateBlogRequest
	(*UpdateBlogResponse)(nil), // 4: blog.UpdateBlogResponse
	(*CreateBlogRequest)(nil),  // 5: blog.CreateBlogRequest
	(*CreateBlogResponse)(nil), // 6: blog.CreateBlogResponse
	(*ReadBlogRequest)(nil),    // 7: blog.ReadBlogRequest
	(*ReadBlogResponse)(nil),   // 8: blog.ReadBlogResponse
}
var file_blog_blogpb_blog_proto_depIdxs = []int32{
	0, // 0: blog.UpdateBlogRequest.blog:type_name -> blog.Blog
	0, // 1: blog.UpdateBlogResponse.blog:type_name -> blog.Blog
	0, // 2: blog.CreateBlogRequest.blog:type_name -> blog.Blog
	0, // 3: blog.CreateBlogResponse.blog:type_name -> blog.Blog
	0, // 4: blog.ReadBlogResponse.blog:type_name -> blog.Blog
	5, // 5: blog.BlogService.CreateBlog:input_type -> blog.CreateBlogRequest
	7, // 6: blog.BlogService.ReadBlog:input_type -> blog.ReadBlogRequest
	3, // 7: blog.BlogService.UpdateBlog:input_type -> blog.UpdateBlogRequest
	1, // 8: blog.BlogService.DeleteBlog:input_type -> blog.DeleteBlogRequest
	6, // 9: blog.BlogService.CreateBlog:output_type -> blog.CreateBlogResponse
	8, // 10: blog.BlogService.ReadBlog:output_type -> blog.ReadBlogResponse
	4, // 11: blog.BlogService.UpdateBlog:output_type -> blog.UpdateBlogResponse
	2, // 12: blog.BlogService.DeleteBlog:output_type -> blog.DeleteBlogResponse
